            ...
            <form data-toggle="validator" role="form" method="post">
                <div class="col-sm-8 clearfix">
                    <div class="bill-to">
                        ...
                        <div class="form-customer">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Tên công ty" name="order[company]">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="tel" placeholder="Di động *" class="form-control" name="order[phone]" value="<?php echo $profile->phone; ?>" required>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="order[address]" placeholder="Đại chỉ" value="<?php echo $profile->address; ?>" data-error="Bạn đang ở đâu dzạ?" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="order-message" style="margin-left: 5px">
                        ...
                        <textarea name="message" name="order[note]"  placeholder="Bạn có thể ghi chú thông tin giao hàng tại đây" rows="16"></textarea>
